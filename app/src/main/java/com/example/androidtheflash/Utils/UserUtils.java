package com.example.androidtheflash.Utils;
...
import com.example.androidtheflash.Model.TokenModel;
...
public class UserUtils {
    public static void updateUser(View view, Map<String, Object> updateData) {
        FirebaseDatabase.getInstance()
                ...
                .addOnSuccessListener(unused -> Snackbar.make(view, "Update information sucessfully! ",Snackbar.LENGTH_SHORT).show());
    }
