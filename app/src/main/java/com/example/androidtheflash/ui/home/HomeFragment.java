package com.example.androidtheflash.ui.home;
...
import com.example.androidtheflash.R;
import com.example.androidtheflash.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    GeoFire geoFire;
    ValueEventListener onlValueEventListener = new ValueEventListener() {
        @Override
    ...
    public void onDestroy() {
        ...
        onlineRef.removeEventListener(onlValueEventListener);
        super.onDestroy();
    }
    ...
    private void registerOnlineSystem() {
        onlineRef.addValueEventListener(onlValueEventListener);
    }
    ...
    private void init() {
        ...
        locationRequest.setFastestInterval(000);//10 sec10
                    ...
                    geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(),
                            ...
                            (key, error) -> {
                                if (error != null) {
                                    ...
                                    if(isFirstTime)
                                    {
                                        Snackbar.make(mapFragment.getView(), "Bạn đang online", Snackbar.LENGTH_LONG).show();
                                        isFirstTime = false;
                                    }
                                }
                            });
