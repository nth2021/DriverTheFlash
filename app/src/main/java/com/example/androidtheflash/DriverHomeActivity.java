...
import com.example.androidtheflash.databinding.ActivityDriverHomeBinding;
...
//
    ...
    private void init(){
        ...
        TextView txt_start = (TextView)headerView.findViewById(R.id.txt_star);
        ...
        txt_start.setText(Common.currentUser !=null ? String.valueOf(Common.currentUser.getRating()) : "0.0");
